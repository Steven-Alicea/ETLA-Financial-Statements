...
target_file = "NFCU Savings Transactions.csv"


def etl_nfcu_savings_transactions(start_year, end_year):
    csv_files = []
    dataframes = []
    for i in range(start_year, end_year + 1):
        csv_directory = (f"data/raw/NFCU/Savings/{i}/Transactions")
...
def main():
    etl_nfcu_savings_transactions(2021, 2023)
