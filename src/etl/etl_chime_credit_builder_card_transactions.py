...
target_file = "Chime Credit Builder Card Transactions.csv"


def etl_chime_credit_builder_card_transactions(start_year, end_year):
    csv_files = []
    dataframes = []
    for i in range(start_year, end_year + 1):
        csv_directory = (f"data/raw/Chime/Credit Builder Card/{i}/Transactions")
...
def main():
    etl_chime_credit_builder_card_transactions(2022, 2023)
